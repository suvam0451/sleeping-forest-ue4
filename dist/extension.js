...
module.exports = JSON.parse("[{\"buildspace\":\"Extended\",\"templates\":[{\"id\":\"Actor\",\"classprefix\":\"A$1\",\"Headers\":[\"CoreMinimal.h\",\"GameFramework/Actor.h\"],\"Functions\":[\"BeginPlay\",\"Tick\"]},{\"id\":\"ActorComponent\",\"classprefix\":\"A$1\",\"Headers\":[],\"Functions\":[]}]}]");
                    ...
                    bs.templates.forEach((tmpl) => {
                        if (tmpl.id === kit.parentclass) {
                            FileHelper_1.InjectHeaders(kit.headerpath, tmpl.Headers).then(() => {
                                FileHelper_1.InjectFunctions(kit.headerpath, kit.sourcepath, tmpl.Functions, sym.namespace);
                                resolve();
                            });
                            resolve();
                        }

...
module.exports = JSON.parse("[{\"buildspace\":\"Extended\",\"templates\":[{\"id\":\"ActorExtendedSample\",\"classprefix\":\"A$1\",\"Headers\":[\"CoreMinimal.h\",\"GameFramework/Actor.h\",\"$1.generated.h\"],\"Functions\":[[{\"description\":\"// Called when the game starts or when spawned\",\"signature\":\"virtual void BeginPlay() override;\",\"field\":\"public\",\"body\":[\"Super::BeginPlay();\"]},{\"description\":\"// Called when the game starts or when spawned\",\"signature\":\"virtual void Tick() override;\",\"field\":\"public\",\"body\":[\"Super::Tick();\"]}]]},{\"id\":\"ActorComponent\",\"classprefix\":\"A$1\",\"Headers\":[],\"Functions\":[]}]}]");
...
module.exports = JSON.parse("[{\"buildspace\":\"Default\",\"templates\":[{\"id\":\"Actor\",\"classprefix\":\"A$1\",\"Headers\":[\"CoreMinimal.h\",\"GameFramework/Actor.h\",\"$1.generated.h\"],\"Functions\":[[{\"description\":\"// Called when the game starts or when spawned\",\"signature\":\"virtual void BeginPlay() override;\",\"field\":\"public\",\"body\":[\"Super::BeginPlay();\"]},{\"description\":\"// Called when the game starts or when spawned\",\"signature\":\"virtual void Tick() override;\",\"field\":\"public\",\"body\":[\"Super::Tick();\"]}]]},{\"id\":\"ActorComponent\",\"classprefix\":\"A$1\",\"Headers\":[],\"Functions\":[]},{\"id\":\"Character\",\"classprefix\":\"A$1\",\"Headers\":[],\"Functions\":[]},{\"id\":\"Interface\",\"classprefix\":\"A$1\",\"Headers\":[],\"Functions\":[]},{\"id\":\"Object\",\"classprefix\":\"U$1\",\"Headers\":[],\"Functions\":[]},{\"id\":\"DataAsset\",\"classprefix\":\"U$1\",\"Headers\":[],\"Functions\":[]}]},{\"buildspace\":\"Minimal\",\"templates\":[]},{\"buildspace\":\"Debashish\",\"templates\":[]}]");

/***/ }),

/***/ "./src/data/IncludeMapping.json":
/*!**************************************!*\
  !*** ./src/data/IncludeMapping.json ***!
  \**************************************/
/*! exports provided: Spline, Procedural, default */
/***/ (function(module) {
...
/***/ "./src/data/generators/Actor_h.json":
/*!******************************************!*\
  !*** ./src/data/generators/Actor_h.json ***!
  \******************************************/
...
module.exports = JSON.parse("[[\"// Fill out your copyright notice in the Description page of Project Settings.\\n\"],[\"#include \\\"$1.generated.h\\\"\\n\"],[\"UCLASS()\"],[\"class $3_API $2 : public AActor\"],[\"{\",\"\\tGENERATED_BODY()\\n\",\"public:\"],[\"\\t$2();\\n\",\"protected:\\n\",\"private:\\n\",\"};\"]]");

/***/ }),

/***/ "./src/data/headerFunctions.json":
/*!***************************************!*\
  !*** ./src/data/headerFunctions.json ***!
  \***************************************/
/*! exports provided: AActor, UActorComponent, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"AActor\":{\"OnConstruction\":{\"comment\":\"Called when an instance of this class is placed (in editor) or spawned.\",\"tutorial\":[\"Use it to make updates when designer changes values.\",\"Add a boolean switch. Do something if designer activates it and set it to false at end of your update\",\"This way you can have an on-demand update instead of everytime. e.g.\",\"if(switch == true) {\",\"\\t// call public function here\",\"}\"],\"header\":\"virtual void OnConstruction(const FTransform &Transform) override;\",\"source\":{\"prototype\":\"::OnConstruction(const FTransform &Transform)\",\"returnType\":\"void\"},\"access\":\"protected\",\"important\":true}},\"UActorComponent\":{}}");
...
const Actor_h_json_1 = __importDefault(__webpack_require__(/*! ../data/generators/Actor_h.json */ "./src/data/generators/Actor_h.json"));
function Takizawa() {
    let classList = [];
    let arrr = BuildTemplates_json_1.default.concat(BuildExtension_json_1.default);
    arrr.forEach((ret) => {
...
function ClassSelection(data) {
    return __awaiter(this, void 0, void 0, function* () {
        let classList = [];
        let arrr = [BuildTemplates_json_1.default];
        arrr.concat(BuildExtension_json_1.default);
        arrr.forEach((ret) => {
            ret.forEach((ret2) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            let spaceindex = BuildTemplates_json_1.default.findIndex((ele) => { ele.buildspace === data.buildspace; });
            if (spaceindex === -1) {
                reject("Internal Error.");
            }
            BuildTemplates_json_1.default[spaceindex].templates.forEach((tmpl) => {
        ...
        return new Promise((resolve, reject) => {
            fs.readdir(pluginPath, (err, folders) => {
                ...
                vscode.window.showQuickPick(lst).then((sel) => {
                    ...
                    else if (((_a = index) === null || _a === void 0 ? void 0 : _a.foldername) === "Game") {
...
function HandleClassGeneration(kit) {
    ...
    switch (kit.parentclass) {
        case "Actor": {
            ParseAndWrite(headerfilepath, Actor_h_json_1.default, GenerateSymbols(kit));
            break;
        }
...
function GenerateSymbols(kit) {
    let retval = {
        classname: kit.classname,
        namespace: "",
        apiname: kit.modulename // $3
    };
    BuildTemplates_json_1.default.forEach((val) => {
...
function ParseAndWrite(filepath, data, symbols) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.default = ErrorSearchModule;


/***/ }),

/***/ "./src/modules/IncludeManager.ts":
/*!***************************************!*\
  !*** ./src/modules/IncludeManager.ts ***!
  \***************************************/
/*! no static exports found */
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            ...
            vscode.window.showQuickPick(marr).then((retval) => {
                switch (retval) {
                    case "Procedural": {
                        list = IncludeMapping_json_1.default.Procedural;
                        break;
                    }
                    case "Spline": {
                        list = IncludeMapping_json_1.default.Spline;
                        break;
                    }
                    default: {
                        break;
...
var XRegExp = __webpack_require__(/*! xregexp */ "./node_modules/xregexp/lib/index.js");
var path = __webpack_require__(/*! path */ "path");
const ext = __importStar(__webpack_require__(/*! ./ExtensionHelper */ "./src/utils/ExtensionHelper.ts"));
const ErrorLogger_1 = __webpack_require__(/*! ./ErrorLogger */ "./src/utils/ErrorLogger.ts");
const fs = __webpack_require__(/*! fs */ "fs");
const filesys = __importStar(__webpack_require__(/*! ./FilesystemHelper */ "./src/utils/FilesystemHelper.ts"));
function ActiveFileName(editor) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            var _a;
            if (editor) {
                // non-null assertion operator
                let FilePath = (_a = vscode.window.activeTextEditor) === null || _a === void 0 ? void 0 : _a.document.fileName;
...
function InjectHeaders(editor, lines) {
    var _a;
    const position = (_a = editor) === null || _a === void 0 ? void 0 : _a.selection.active;
...
(function (UE4_ClassTypes) {
    UE4_ClassTypes[UE4_ClassTypes["UObject"] = 0] = "UObject";
    UE4_ClassTypes[UE4_ClassTypes["Actor"] = 1] = "Actor";
    UE4_ClassTypes[UE4_ClassTypes["Enum"] = 2] = "Enum";
    UE4_ClassTypes[UE4_ClassTypes["Interface"] = 3] = "Interface";
    UE4_ClassTypes[UE4_ClassTypes["FStruct"] = 4] = "FStruct";
})(UE4_ClassTypes = exports.UE4_ClassTypes || (exports.UE4_ClassTypes = {}));
...
function GetLineMatchingRegexInActiveFile(ex) {
    let editor = vscode.window.activeTextEditor;
    ...
    return new Promise((resolve, reject) => {
        ...
        reject(ErrorLogger_1.DErrorCode.HEADER_NOT_FOUND);
    });
}
exports.GetLineMatchingRegexInActiveFile = GetLineMatchingRegexInActiveFile;
/** Writes prototypes to both header and function */
function AddFunction(data, func, FromHeader) {
    if (FromHeader === true) {
...
var DErrorCode;
(function (DErrorCode) {
    DErrorCode[DErrorCode["HEADER_NOT_FOUND"] = 0] = "HEADER_NOT_FOUND";
    DErrorCode[DErrorCode["SOURCE_NOT_FOUND"] = 1] = "SOURCE_NOT_FOUND";
    DErrorCode[DErrorCode["FILE_NOT_FOUND"] = 2] = "FILE_NOT_FOUND";
    DErrorCode[DErrorCode["NO_ACTIVE_DOCUMENT"] = 3] = "NO_ACTIVE_DOCUMENT";
    DErrorCode[DErrorCode["HEADER_NOT_CONFORMANT"] = 4] = "HEADER_NOT_CONFORMANT";
})(DErrorCode = exports.DErrorCode || (exports.DErrorCode = {}));
function ThrowError(err) {
    switch (err) {
        ...
        case DErrorCode.NO_ACTIVE_DOCUMENT: {
            vscode.window.showInformationMessage("It seems your cursor might be in the terminal or sidebars. \
                You need to be focused on a .h/.cpp document to run this.");
            break;
        }
        case DErrorCode.HEADER_NOT_FOUND: {
            vscode.window.showInformationMessage("Could not detect the paired source file.");
            break;
        }
        case DErrorCode.HEADER_NOT_FOUND: {
            vscode.window.showInformationMessage("Could not detect the paired header file.");
            break;
        }
        case DErrorCode.HEADER_NOT_CONFORMANT: {
            vscode.window.showInformationMessage("This file(header) doesn't seem to be UE4 syntax conformant.");
            break;
        }
        default: break;
    }
...
(function (ActiveFileExtension) {
    ...
    ActiveFileExtension[ActiveFileExtension["Header"] = 1] = "Header";
    ActiveFileExtension[ActiveFileExtension["Source"] = 2] = "Source";
    ActiveFileExtension[ActiveFileExtension["BothFound"] = 3] = "BothFound";
})(ActiveFileExtension = exports.ActiveFileExtension || (exports.ActiveFileExtension = {}));
/** Gets all the information about currently focused file... */
function GetActiveFileData() {
    let retval = {
    ...
    if (ExtensionHelper_1.IsHeaderFile(retval.filename)) {
    ...
    else if (ExtensionHelper_1.IsSourceFile(retval.filename)) {
...
exports.GetActiveFileData = GetActiveFileData;
/** Gets the .h counterpart if standard convention was respected. */
function GetMatchingHeader(data) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.GetMatchingHeader = GetMatchingHeader;
/** Gets the .cpp counterpart if standard convention was respected. */
function GetMatchingSource(data) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.GetMatchingSource = GetMatchingSource;
/** Scan a folder with specified regex to find matches. Empty string if none found. */
function ScanFolderWithRegex(dir, ex) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
...
function WriteFunctionToFile(filepath, funcBody, classname) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            ...
            fs.appendFile(filepath, PreferredBrackets, (err) => {
                if (err) { } // handle error
